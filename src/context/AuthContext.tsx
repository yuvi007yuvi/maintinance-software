...
export const PREDEFINED_USERS: PredefinedUser[] = [
  {
    ...
    email: 'commissioner@nagarnigamaligarh.in',
    phone: '+91 94120 00002',
    role: 'nagar_nigam_officer',
    designation: 'Municipal Commissioner',
    department: 'Nagar Nigam Executive Secretariat',
    zone_id: 'zone-1',
    is_active: true,
  },
  {
    ...
    email: 'fleet.mgr@nagarnigamaligarh.in',
  ...
  },
  {
    ...
    email: 'workshop.chief@nagarnigamaligarh.in',
    phone: '+91 94120 00005',
    role: 'workshop_manager',
    designation: 'Central Workshop Superintendent',
    department: 'Bannadevi Central Depot',
    zone_id: 'zone-2',
    is_active: true,
  },
  {
    ...
    email: 'kallu.mechanic@nagarnigamaligarh.in',
  ...
  },
  {
    ...
    email: 'rameshwar.driver@nagarnigamaligarh.in',
  ...
  },
  {
    ...
    email: 'admin@nagarnigamaligarh.in',
    phone: '+91 94120 00001',
    role: 'super_admin',
    designation: 'System Administrator & NIC Liaison',
    department: 'Municipal IT & Smart City Mission',
    zone_id: 'zone-1',
    is_active: true,
  },
];
  ...
  const login = async (email: string, _password?: string): Promise<{ success: boolean; message?: string }> => {
    ...
    if (cleanEmail.includes('@')) {
      const genericUser: PredefinedUser = {
        ...
        department: 'Nagar Nigam Aligarh',
        is_active: true,
      };
