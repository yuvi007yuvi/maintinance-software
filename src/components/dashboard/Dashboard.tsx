...
export const Dashboard: React.FC<DashboardProps> = ({ onNavigate, onOpenReportBreakdown }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-white via-white to-emerald-50/70 dark:from-slate-900 dark:via-slate-900 dark:to-emerald-950/40 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
